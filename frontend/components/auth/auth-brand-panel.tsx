...
export function AuthBrandPanel({ title, subtitle }: { title: string; subtitle: string }) {
  return (
    <div className="hidden md:flex w-[210px] shrink-0 bg-tinta p-6 flex-col relative overflow-hidden">
      ...
      {/* Decorative tilted mini creator card */}
      <div className="bg-white border-2 border-tinta rounded-[10px] overflow-hidden -rotate-2 relative z-10 mt-auto">
        <div className="h-1 bg-naranja" />
        <div className="p-2.5">
          <div className="flex items-center gap-1.5 mb-1.5">
            <div className="w-[18px] h-[18px] rounded-full bg-tinta shrink-0" />
            <p className="text-[9.5px] font-semibold text-tinta">DJ Pablo</p>
          </div>
      ...
      <p className="text-[rgba(251,247,242,0.4)] text-[9.5px] mt-2.5 relative z-10">
